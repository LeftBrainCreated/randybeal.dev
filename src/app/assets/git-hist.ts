...
export const gitHistContent = [
    ...
    {
        subject: "eCommerce Cloud Marketplace v2",
        branch: "Developer",
        tag: "",
        techStack: [
            "Angular",
    ...
    {
        subject: "Enterprise Billing Application",
        branch: "Developer",
        tag: "",
        techStack: [
            "C#",
    ...
    },
    {
        ...
        description: "This notification Service was an Azure MSA component used for internal communcation through multiple distribution methods for pre-defined system events. My responsibilities here were architecture, documentation, and Proof of Concept to design from greenfield to release this kubernetes hosted solution.",
        images: [
